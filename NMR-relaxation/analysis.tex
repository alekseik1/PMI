...
Отложим теперь времена $ T_1 $, $ T_2 $ на одном графике в зависимости от концентрации раствора для двух разных солей (рисунки \ref{fig:t1-from-c} и \ref{fig:t2-from-c}).
\begin{figure}[H]
	\centering
